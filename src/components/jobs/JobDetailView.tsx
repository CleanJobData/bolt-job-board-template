    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
        ...
        <div className="flex flex-col gap-3 min-w-[160px]">
          {job.application_url && (
            <Button size="lg" className="w-full shadow-lg shadow-primary/20 py-6 md:py-2" href={job.application_url}>
              Apply Now
      ...
      {/* Key Info Badges */}
      {job.has_remote || job.experience_level || job.employment_type || salaryDisplay && (
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {job.company && (
            <div className="lg:hidden border border-border rounded-xl overflow-hidden bg-card shadow-sm">
              ...
              {isCompanyExpanded && (
                <div className="p-4 pt-0 border-t border-border/50 space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    {job.company.linkedin_url && (
                      <a href={job.company.linkedin_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#0077B5] transition-colors">
                        <FaLinkedin className="h-3.5 w-3.5" />
                      </a>
                    )}
                    {job.company.twitter_url && (
                      <a href={job.company.twitter_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#1DA1F2] transition-colors">
                        <FaTwitter className="h-3.5 w-3.5" />
                      </a>
                    )}
                    {job.company.website_url && (
                      <a href={job.company.website_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-primary transition-colors">
                        <FaGlobe className="h-3.5 w-3.5" />
                      </a>
                    )}
                  </div>
          ...
          {job.company && (
            <div className="space-y-6 p-6 rounded-2xl border border-border bg-card shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {job.company.linkedin_url && (
                    <a href={job.company.linkedin_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#0077B5] transition-colors" title="LinkedIn">
                      <FaLinkedin className="h-4 w-4" />
                    </a>
                  )}
                  {job.company.twitter_url && (
                    <a href={job.company.twitter_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#1DA1F2] transition-colors" title="Twitter">
                      <FaTwitter className="h-4 w-4" />
                    </a>
                  )}
                  {job.company.github_url && (
                    <a href={job.company.github_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-foreground transition-colors" title="GitHub">
                      <FaGithub className="h-4 w-4" />
                    </a>
                  )}
                  {job.company.youtube_url && (
                    <a href={job.company.youtube_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#FF0000] transition-colors" title="YouTube">
                      <FaYoutube className="h-4 w-4" />
                    </a>
                  )}
                  {job.company.facebook_url && (
                    <a href={job.company.facebook_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#1877F2] transition-colors" title="Facebook">
                      <FaFacebook className="h-4 w-4" />
                    </a>
                  )}
                  {job.company.instagram_url && (
                    <a href={job.company.instagram_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-[#E4405F] transition-colors" title="Instagram">
                      <FaInstagram className="h-4 w-4" />
                    </a>
                  )}
                  {job.company.website_url && (
                    <a href={job.company.website_url} target="_blank" rel="noopener noreferrer" className="p-2 rounded-md bg-muted hover:bg-muted/80 text-muted-foreground hover:text-primary transition-colors" title="Website">
